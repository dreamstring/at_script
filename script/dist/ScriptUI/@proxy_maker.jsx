    ...
    (function(global) {
        ...
        var builder = new Atarabi.UI.Builder(global instanceof Panel ? global : "palette", SCRIPT_NAME, {
            ...
            ui.onClick = function() {
                ...
                var createFile = function(frame) {
                    return new File("".concat(proxyFolder.absoluteURI, "/").concat(prefix, "_").concat(zfill(frame, 5), ".png"));
                };
                try {
                    app.beginUndoGroup(SCRIPT_NAME);
                    var workAreaStart = comp.workAreaStart, workAreaDuration = comp.workAreaDuration, frameDuration_1 = comp.frameDuration;
                    var secondToFrame = function(time) {
                        return Math.round(time / frameDuration_1);
                    };
