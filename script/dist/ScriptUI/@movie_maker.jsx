...
(function() {
    (function(global) {
        ...
        }).addGroupEnd().addGroup(Param.TargetGroup, undefined, function(ui) {
            ui.alignment = [ "fill", "top" ];
            ui.orientation = "row";
            ui.spacing = ui.margins = 1;
        ...
        }).addGroupEnd().addGroup(Param.OptionsGroup, undefined, function(ui, emitter) {
            ui.alignment = [ "fill", "top" ];
            ui.orientation = "row";
            ui.spacing = ui.margins = 1;
        ...
        }).addGroupEnd().addButton(Param.Make, undefined, undefined, function(ui) {
            ui.alignment = [ "fill", "top" ];
            ui.onClick = function() {
                      ...
                      case Target.Comp:
                        {
                            switch (type) {
                              case Type.Gif:
                                ...
                                Atarabi.comp.saveFramesToGif(comp, startTime, endTime, file, {
                              ...
                              case Type.Apng:
                                ...
                                Atarabi.comp.saveFramesToApng(comp, startTime, endTime, file, {
                                    downsample: downsample,
                                    skip: skip,
                                    speed: speed
                                });
                            ...
                            if (isAVLayer(layer)) {
                                switch (type) {
                                  case Type.Gif:
                                    ...
                                    Atarabi.layer.saveFramesToGif(layer, startTime, endTime, file, {
                                        downsample: downsample,
                                        skip: skip,
                                        speed: speed
                                    });
                                  ...
                                  case Type.Apng:
                                    ...
                                    Atarabi.layer.saveFramesToApng(layer, startTime, endTime, file, {
                                        downsample: downsample,
                                        skip: skip,
                                        speed: speed
                                    });
