...
(function() {
    (function(global) {
        ...
        function createPreset() {
                    ...
                    if (isValidProperty(property)) {
                        if (property.numKeys > 0) {
                            ...
                            if (Atarabi.property.isModified(property)) {
                                value = transformValue(layer, property, Atarabi.property.getValue(property, {
                                    preExpression: true
                                }));
                            }
                        }
            ...
            var name = map(effectItems, function(item) {
                return item.name;
            }).join(" / ");
            do {
        ...
        function applyPropertyItems(layer, effect, propertyItem) {
            ...
            if (propertyItem.values != null) {
                for (var _i = 0, _a = propertyItem.values; _i < _a.length; _i++) {
                    ...
                    Atarabi.property.setValue(property, transformValue(layer, property, value, false), {
        ...
        }).addGroupEnd().addListBox(Param.PresetList, undefined, {
            numberOfColumns: 2,
