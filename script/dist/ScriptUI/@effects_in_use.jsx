    ...
    (function(global) {
        ...
        function updateEffectList() {
                    ...
                    for (var j = 1; j <= item.numLayers; j++) {
                        ...
                        if (isAVLayer(layer)) {
                            for (var k = 1; k <= layer.effect.numProperties; k++) {
                                ...
                                effectList[effect.matchName].push({
                                    layer: layer,
                                    name: effect.name,
            ...
            for (var matchName in effectList) {
                effectArray.push({
                    matchName: matchName,
                    number: effectList[matchName].length
                });
            }
        ...
        new Atarabi.UI.Builder(global instanceof Panel ? global : "palette", SCRIPT_NAME, {
            resizeable: true
        }, function(win) {
        ...
        }).addListBox(Param.EffectList, undefined, {
            numberOfColumns: 3,
            showHeaders: true,
            columnWidths: [ 150, 150, 50 ],
            columnTitles: [ "Name", "Match Name", "Number" ]
        }, function(ui, emitter) {
        ...
        }).addListBox(Param.InstanceList, undefined, {
            numberOfColumns: 3,
            showHeaders: true,
            columnWidths: [ 100, 100, 100 ],
            columnTitles: [ "Comp", "Layer", "Effect" ]
        }, function(ui, emitter) {
            ui.alignment = [ "fill", "fill" ];
