...
(function() {
    (function() {
        ...
        Atarabi.register.hookCommand(2038, function() {
            main();
        });
        function main() {
            ...
            var black = [ 0, 0, 0 ];
            var white = [ 1, 1, 1 ];
            var win = new Window("dialog", "Solid Settings", undefined, {
                resizeable: false
            });
            ...
            okButton.onClick = function() {
                try {
                    ...
                    var solidLayer = addSolid(comp, solidWidth, solidHeight, settings.useFillEffect ? white : currentColor);
                    if (settings.useFillEffect) {
                        var fillEffect = solidLayer.effect.addProperty(ADOBE_FILL);
