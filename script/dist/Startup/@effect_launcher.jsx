...
(function() {
    (function() {
        ...
        function getShortcutValues(perms) {
            var _a;
            if (perms === void 0) {
                perms = (_a = {}, _a[Type.Effect] = true, _a[Type.Script] = true, _a[Type.Preset] = true, 
                _a);
            }
            var values = [];
                ...
                scanFiles(SETTINGS.script, SCRIPT_RE, function(root, file) {
                    if (root) {
                        SCRIPT_LIST.push({
                            ...
                            category: "Script",
                            detail: file.fsName.substr(root.fsName.length + 1),
                            path: file.fsName
                        });
                    } else {
                        SCRIPT_LIST.push({
        ...
        function generateShortcutKey(settings, name, defaultKey) {
            ...
            var newKey = null;
            new Atarabi.UI.Builder("dialog", "Create a shortcut", {
                resizeable: true
            }, function(win) {
                win.spacing = 8;
                win.margins = 10;
            ...
            }).addGroupEnd().addGroup(Param.ButtonGroup, undefined, function(ui, emitter) {
                ui.alignment = [ "fill", "top" ];
                ui.orientation = "row";
        ...
        function getActiveLayers() {
            ...
            var comp = activeLayer ? activeLayer.containingComp : Atarabi.comp.getMostRecentlyUsedComp();
            if (comp) {
        ...
        function buildSettingsUI() {
            ...
            var update = false;
            new Atarabi.UI.Builder("dialog", "Settings", undefined, function(win) {
                win.spacing = 8;
                win.margins = 10;
                ...
                ui.spacing = 3;
                ui.margins = 10;
            }).addListBox(Param.ShortcutList, undefined, {
                numberOfColumns: 4,
                ...
                ui.addEventListener("mousedown", function(e) {
                    ...
                    if (e.button === 2) {
                        var index = Atarabi.UI.showContextMenu([ {
                            text: "Edit"
                        }, {
                            text: "Delete"
                        } ]);
            ...
            }).addGroupEnd().addPanelEnd().addPanel(Param.ScriptPanel, "Script", undefined, function(ui, emitter) {
                ui.alignment = [ "fill", "fill" ];
                ui.preferredSize[0] = 350;
                ui.spacing = 3;
                ui.margins = 10;
            ...
            }).addListBox(Param.ScriptFoldersList, undefined, {
                numberOfColumns: 2,
                ...
                emitter.addEventListener(Event.NewScriptFolder, function() {
                    ...
                    if (folder) {
                        ...
                        newSettings.script.folders.push({
                            path: folder.fsName,
                            recursive: false
                        });
                    }
            ...
            }).addGroupEnd().addPanel(Param.ScriptSeparator, "", undefined, function(ui, emitter) {
                ui.alignment = [ "fill", "top" ];
                ui.preferredSize[1] = 1;
            }).addPanelEnd().addStaticText(Param.ScriptFilesText, "Files", undefined, function(ui, emitter) {
                ui.alignment = [ "left", "top" ];
            }).addListBox(Param.ScriptFilesList, undefined, {
                numberOfColumns: 2,
                columnWidths: [ 150, 200 ]
            }, function(ui, emitter) {
                ui.alignment = [ "fill", "fill" ];
            ...
            }).addGroupEnd().addPanelEnd().addPanel(Param.PresetPanel, "Preset", undefined, function(ui, emitter) {
                ui.alignment = [ "fill", "fill" ];
                ui.preferredSize[0] = 350;
                ui.spacing = 3;
                ui.margins = 10;
                ...
                ui.alignment = [ "left", "top" ];
            }).addListBox(Param.PresetFoldersList, undefined, {
                numberOfColumns: 2,
                columnWidths: [ 150, 200 ]
            }, function(ui, emitter) {
                ui.alignment = [ "fill", "fill" ];
                ...
                emitter.addEventListener(Event.NewPresetFolder, function() {
                    ...
                    if (folder) {
                        var newItem = ui.add("item", folder.displayName);
                        newItem.subItems[0].text = folder.fsName;
                        newSettings.preset.folders.push({
                            path: folder.fsName,
                            recursive: false
                        });
                    }
            ...
            }).addGroupEnd().addPanel(Param.PresetSeparator, "", undefined, function(ui, emitter) {
                ui.alignment = [ "fill", "top" ];
                ui.preferredSize[1] = 1;
            }).addPanelEnd().addStaticText(Param.PresetFilesText, "Files", undefined, function(ui, emitter) {
                ui.alignment = [ "left", "top" ];
            }).addListBox(Param.PresetFilesList, undefined, {
                numberOfColumns: 2,
                columnWidths: [ 150, 200 ]
            }, function(ui, emitter) {
                ui.alignment = [ "fill", "fill" ];
            ...
            }).addGroupEnd().addPanelEnd().addGroupEnd().addGroup(Param.ButtonGroup, undefined, function(ui, emitter) {
                ui.alignment = [ "fill", "bottom" ];
                ui.orientation = "row";
                ui.spacing = ui.margins = 1;
            }).addButton(Param.OK, undefined, undefined, function(ui, emitter) {
        ...
        function buildDefaultUI(ctx, layers) {
            var win = new Window("dialog", undefined, undefined, {
                borderless: true
            });
            win.spacing = 0;
            win.margins = 0;
            ...
            var itemList = win.add("listbox", undefined, undefined, {
                numberOfColumns: 3,
            ...
            function updateList(needle) {
                ...
                var iItems = needle ? searcher.search(needle).slice(0, 50) : RECENT_ITEM_LIST;
                itemList.removeAll();
        ...
        function buildShortcutUI(ctx, layers) {
            var _a;
            var shortcutValues = getShortcutValues((_a = {}, _a[Type.Effect] = false, _a[Type.Script] = true, 
            _a[Type.Preset] = layers.length > 0, _a));
            ...
            var shortcutList = win.add("listbox", undefined, undefined, {
                numberOfColumns: 3,
